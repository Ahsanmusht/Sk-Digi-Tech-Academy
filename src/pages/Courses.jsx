              ...
              <div className='box rounded-lg shadow-shadow1 bg-white'>
                ...
                <div className='text p-3'>
                  ...
                  <div className='user flex items-center'>
                    <img className='rounded-full w-7 h-7' src='https://images.pexels.com/photos/846741/pexels-photo-846741.jpeg?auto=compress&cs=tinysrgb&w=600' alt='' />
                    <span className='text-[14px] ml-2'> John Deo</span>
                  </div>
                </div>
